...
<head>
    ...
    <meta name="description" content="Sistem pendukung penyusunan dan review proposal KKPRL, bukan sistem penerbitan izin resmi.">
    <title>{{ $title ?? 'Layanan Konsultasi LPRL Sorong' }}</title>
