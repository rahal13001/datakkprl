<div
    ...
    class="w-full"
>
    <div class="relative border border-gray-300 dark:border-gray-600 rounded-lg overflow-hidden bg-white dark:bg-gray-800 inline-block"
         style="max-width: {{ $getCanvasWidth() }}px;">
        <canvas
            x-ref="canvas"
            width="{{ $getCanvasWidth() }}"
            height="{{ $getCanvasHeight() }}"
            class="cursor-crosshair w-full touch-none"
            style="aspect-ratio: {{ $getCanvasWidth() }}/{{ $getCanvasHeight() }};"
