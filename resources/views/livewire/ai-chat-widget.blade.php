<div class="krl-chat-widget">
    ...
    <div class="krl-chat-window">
        ...
        <div class="krl-chat-header">
            ...
            <div class="krl-header-actions">
                <button wire:click="clearChat" class="krl-clear-btn" title="Hapus percakapan" aria-label="Hapus percakapan">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/>
                    </svg>
                </button>
                <button wire:click="toggleChat" class="krl-close-btn" aria-label="Tutup bantuan chat">
        ...
        <div class="krl-input-area">
            ...
            <form wire:submit.prevent="sendMessage" class="krl-input-form">
                ...
                <button type="submit" class="krl-send-btn" aria-label="Kirim pesan">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    {{-- Toggle Button --}}
    <button wire:click="toggleChat" class="krl-toggle-btn {{ $isOpen ? 'krl-toggle-open' : '' }}" aria-label="{{ $isOpen ? 'Tutup bantuan chat' : 'Buka bantuan chat' }}">
        @if($isOpen)
