                                ...
                                <div class="bg-indigo-50/50 rounded-2xl border border-indigo-100 p-6">
                                    ...
                                    <form wire:submit="submitFeedback">
                                        ...
                                        <div class="space-y-4 mb-6">
                                            <div>
                                                <label class="block text-xs font-medium text-slate-700 mb-1">Kritik / Umpan Balik <span class="text-red-500">*</span></label>
                                                ...
                                                @error('criticism') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                                            </div>
                                            <div>
                                                <label class="block text-xs font-medium text-slate-700 mb-1">Saran <span class="text-red-500">*</span></label>
