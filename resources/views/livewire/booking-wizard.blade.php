    ...
    <div class="p-6 lg:p-10 min-h-[400px]">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="flex gap-4">
                    <label class="flex items-center gap-2 cursor-pointer p-3 border rounded-xl hover:bg-slate-50 transition-colors {{ $booking_type == 'personal' ? 'border-brand-blue bg-blue-50/50' : 'border-slate-200' }}">
                        <input type="radio" wire:model.live="booking_type" value="personal" class="text-brand-blue focus:ring-brand-blue">
                        <span class="text-slate-700 font-medium">Perorangan</span>
                    </label>
                    <label class="flex items-center gap-2 cursor-pointer p-3 border rounded-xl hover:bg-slate-50 transition-colors {{ $booking_type == 'company' ? 'border-brand-blue bg-blue-50/50' : 'border-slate-200' }}">
                        <input type="radio" wire:model.live="booking_type" value="company" class="text-brand-blue focus:ring-brand-blue">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input wire:model="instance" type="text" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-brand-blue focus:ring-2 focus:ring-blue-100 outline-none transition-all placeholder:text-slate-300" placeholder="PT. Laut Sejahtera">
                </div>
                @endif
            </div>
            ...
            <div>
                ...
                <textarea wire:model="address" rows="2" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-brand-blue focus:ring-2 focus:ring-blue-100 outline-none transition-all placeholder:text-slate-300" placeholder="Alamat lengkap..."></textarea>
            </div>
            ...
            <div class="border-t border-slate-100 pt-8">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <button wire:click="addTechnicalRow" class="text-sm font-semibold text-brand-blue hover:text-blue-700 transition-colors flex items-center gap-2">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden hover:border-brand-blue/30 transition-all group">
                        ...
                        <div class="bg-slate-50 px-4 py-3 border-b border-slate-100 flex justify-between items-center">
                            ...
                            <button wire:click="removeTechnicalRow({{ $index }})" class="text-xs font-semibold text-red-500 hover:text-red-700 hover:bg-red-50 px-2 py-1 rounded-md transition-all flex items-center gap-1">
                        ...
                        <div class="p-5 grid md:grid-cols-12 gap-4">
                            ...
                            <div class="md:col-span-3">
                                ...
                                <div class="relative">
                                    <select wire:model="technical_data.{{ $index }}.nature" class="w-full appearance-none px-3 py-2.5 rounded-lg bg-slate-50 border border-slate-200 focus:bg-white focus:border-brand-blue focus:ring-2 focus:ring-blue-100 outline-none text-sm font-medium text-slate-700 transition-all">
                            ...
                            <div class="md:col-span-5">
                                ...
                                <input wire:model="technical_data.{{ $index }}.activity" type="text" class="w-full px-3 py-2.5 rounded-lg bg-slate-50 border border-slate-200 focus:bg-white focus:border-brand-blue focus:ring-2 focus:ring-blue-100 outline-none text-sm placeholder:text-slate-400 transition-all" placeholder="Contoh: Reklamasi, Dermaga...">
                                @error("technical_data.{$index}.activity") <span class="text-[10px] text-red-500 block mt-1">Wajib diisi</span> @enderror
                            </div>

                            <!-- 3. Luasan / Panjang -->
                            <div class="md:col-span-4">
                                <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Dimensi (Luas/Panjang)</label>
                                <input wire:model="technical_data.{{ $index }}.dimension" type="text" class="w-full px-3 py-2.5 rounded-lg bg-slate-50 border border-slate-200 focus:bg-white focus:border-brand-blue focus:ring-2 focus:ring-blue-100 outline-none text-sm placeholder:text-slate-400 transition-all" placeholder="Contoh: 2 Ha / 150 m">
        ...
        <div class="space-y-8">
            ...
            <div class="bg-blue-50/50 p-6 rounded-2xl border border-blue-100">
                <h4 class="text-sm font-semibold text-slate-700 mb-4"><i class="fa-solid fa-calendar-plus mr-2 text-brand-blue"></i> Tambah Jadwal</h4>
                
                <div class="flex flex-col md:flex-row gap-4 items-end">
                    <!-- Date Picker -->
                    <div class="w-full">
                        <label class="block text-sm font-semibold text-slate-700 mb-2">Pilih Tanggal</label>
                        <input wire:model.live="date" type="date" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-brand-blue outline-none text-slate-700 font-medium">
                    </div>
                    ...
                    <div class="w-full">
                        ...
                        <select wire:model="time_slot" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-brand-blue outline-none text-slate-700 font-medium">
                    ...
                    <div class="w-full md:w-auto">
                        <button wire:click="addSchedule" class="w-full md:w-auto px-6 py-3 bg-brand-blue text-white rounded-xl font-medium hover:bg-blue-700 transition-colors whitespace-nowrap">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between p-4 bg-white border border-slate-200 rounded-xl shadow-sm">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="font-bold text-slate-900">{{ \Carbon\Carbon::parse($item['date'])->isoFormat('dddd, D MMMM Y') }}</p>
                                <p class="text-sm text-slate-500">Pukul {{ $item['time'] }} - {{ \Carbon\Carbon::parse($item['time'])->addHour()->format('H:i') }}</p>
                            </div>
                        </div>
                        <button wire:click="removeSchedule({{ $index }})" class="text-slate-400 hover:text-red-500 transition-colors p-2">
